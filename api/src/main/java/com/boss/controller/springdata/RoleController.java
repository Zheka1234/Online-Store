...
import com.boss.service.role.RolesServiceImpl;
...
public class RoleController {
    ...
    public ResponseEntity<Object> createRole(
        ...
        model.put("role", service.findById(hibernateRole.getIdRole().intValue()));
    ...
    public ResponseEntity<Object> findById(@PathVariable String id) {
        ...
        return new ResponseEntity<>(
                Collections.singletonMap("error", service.findById(roleId)), HttpStatus.OK);
    }
}
